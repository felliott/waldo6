...
sub process_post {
    ...
    # convert certain kinds of results into more useful forms
    ...
    # return anything else as raw JSON wrapped in a hash
        ...
        # If anything more is needed then it should be handled via
        # e.g. a specific resource class for the method.
